...
\begin{theorem}[{Query Version \cite[Theorem~2]{12WSNE}}]
  For any constants $\varepsilon, \delta > 0$, with $O\left( \frac{n \log n}{\varepsilon^4} \right)$ payoff queries, one can find a $(1/2 + 3\varepsilon + \delta)$-WSNE in polynomial time and with success probability at least $\left( 1 - n^{-\frac{1}{8}} \right)\left( 1 - \frac{2}{n} \right)^2$.
\end{theorem}
...
\begin{remark}
  The original paper mistakenly invokes Lemma~1 at this point; but actually, the needed conclusion is the $3\varepsilon$-WSNE guarantee of Lemma~2 \cite[proof of Theorem~2]{12WSNE}.
\end{remark}
