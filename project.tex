...
\begin{lemma}[{\cite[Lemma~1]{12WSNE} (implied by the proof of \cite[Theorem~1]{lmm03})}]
...
(Bonus: in the original paper, the justification for the row player mistakenly cites Lemma 1 instead of Lemma 2; a small typo, although Lemma 2 is also built upon Lemma 1.)
