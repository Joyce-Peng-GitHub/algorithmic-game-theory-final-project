...
\subsection{Algorithm~\ref{alg:full-information}}
\label{app:case-analysis-details-algo-1}

\subsubsection{Algorithm~\ref{alg:full-information}, Case 1(a)}
...
\subsubsection{Algorithm~\ref{alg:full-information}, Case 1(b)}
...
\subsubsection{Algorithm~\ref{alg:full-information}, Case 1(c)}
...
\subsection{Algorithm~\ref{alg:query-efficient}}
\label{app:case-analysis-details-algo-2}

\subsubsection{Algorithm~\ref{alg:query-efficient}, Case 2(a)}
...
\subsubsection{Algorithm~\ref{alg:query-efficient}, Case 2(b)}
...
\subsubsection{Algorithm~\ref{alg:query-efficient}, Case 2(c)}
